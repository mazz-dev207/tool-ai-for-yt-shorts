...
from src.highlights.ranking import diversity_rerank, remove_overlaps, validate_judgement, validate_scores
...
class GeminiHighlightTests(unittest.TestCase):
    ...
    def test_boundary_refinement_is_clamped(self):
        ...
        raw = {
            ...
            "refined_end": 999.0,
            "scores": {
                "hook": 20, "payoff": 15, "emotion": 10, "visual_action": 10,
                "surprise": 8, "standalone": 8, "replayability": 4,
            },
            "category": "surprise",
            "reason": "test",
        ...
        result = validate_judgement(
            raw, candidate=candidate, video_duration=60.0,
            profile=get_profile("general"), context_start=5.0, context_end=40.0,
        )
