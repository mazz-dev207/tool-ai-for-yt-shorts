...
def has_executable_v3_changes(video_name: str) -> bool:
    """Return True only when downstream editorial media must be rebuilt.
    ...
    Caption Hook is intentionally NOT counted here: it is a presentation-layer
    rebuild handled separately by main.py and must not force SmartCut3 or alter
    highlight boundaries by itself.
    """
