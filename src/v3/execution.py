...
def has_executable_v3_changes(video_name: str) -> bool:
    """Return True only when at least one Short needs V3 timeline/effects execution.

    This gate keeps fallback behavior genuinely V2-compatible when editorial
    reasoning is unavailable or all clips are intentionally left unchanged.
    """
