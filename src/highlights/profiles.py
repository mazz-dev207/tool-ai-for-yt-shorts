...
PROFILES = {
    "general": ContentProfile(
        ...
        weights={"hook": 25, "payoff": 20, "emotion": 15, "visual_action": 15, "surprise": 10, "standalone": 10, "replayability": 5},
    ),
    "gaming": ContentProfile(
        ...
        weights={"emotion": 20, "visual_action": 20, "surprise": 20, "payoff": 15, "hook": 15, "standalone": 5, "replayability": 5},
    ),
    "entertainment": ContentProfile(
        ...
        weights={"hook": 20, "payoff": 20, "emotion": 20, "surprise": 15, "visual_action": 10, "standalone": 10, "replayability": 5},
    ),
    "podcast": ContentProfile(
        ...
        weights={"hook": 25, "standalone": 20, "replayability": 15, "emotion": 10, "surprise": 10, "payoff": 15, "visual_action": 5},
    ),
    "reaction": ContentProfile(
        ...
        weights={"emotion": 20, "surprise": 20, "hook": 20, "payoff": 15, "visual_action": 10, "standalone": 10, "replayability": 5},
    ),
}
...
def infer_profile(candidate: dict, requested: str | None = None) -> ContentProfile:
    ...
    aliases = {"challenge": "entertainment", "storytelling": "entertainment", "interview": "podcast", "livestream": "reaction"}
